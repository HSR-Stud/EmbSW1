...
\subsection{Realisierung mit Steuerkonstrukt (prozedural in C)\buch{p. 12}}
\begin{figure}[h]
  \centering
...
\lstinputlisting[style=Cpp]{snippets/Ctrl_Cpp/counter.h}
\lstinputlisting[style=Cpp]{snippets/Ctrl_Cpp/counter.cpp}
\lstinputlisting[style=Cpp]{snippets/Ctrl_Cpp/counterTest.cpp}
